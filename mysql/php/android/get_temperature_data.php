...
// Adjusted to match dump.sql table 'temperature' and columns 'temperature', 'id'
$sql = "SELECT temperature as temperatura, id as idtemperatura FROM temperature ORDER BY id ASC";
