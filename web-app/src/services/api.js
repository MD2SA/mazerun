const API_URL = import.meta.env.VITE_API_URL || 'http://127.0.0.1:8000/web/api.php';
...
export const api = {
  ...
  getUnifiedLogs: (simId, limit = 100, team = null, offset = 0) => request('get_unified_logs', { simulation_id: simId, limit, team, offset }),
